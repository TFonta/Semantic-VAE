...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(1800, 460)
        self.pushButton = QtWidgets.QPushButton(Form)
        self.pushButton.setGeometry(QtCore.QRect(928, 120, 81, 27))
        ...
        self.pushButton_28.setGeometry(QtCore.QRect(928, 220, 81, 27))
        self.pushButton_28.setObjectName("pushButton_28")

        self.pushButton_29 = QtWidgets.QPushButton(Form)
        self.pushButton_29.setGeometry(QtCore.QRect(928, 320, 81, 27))
        self.pushButton_29.setObjectName("pushButton_29")

        self.pushButton_30 = QtWidgets.QPushButton(Form)
        self.pushButton_30.setGeometry(QtCore.QRect(10, 70, 97, 27))
        self.pushButton_30.setObjectName("pushButton_30")

        self.pushButton_31 = QtWidgets.QPushButton(Form)
        self.pushButton_31.setGeometry(QtCore.QRect(928, 420, 81, 27))
        self.pushButton_31.setObjectName("pushButton_31")

        self.graphicsView = QtWidgets.QGraphicsView(Form)
        self.graphicsView.setGeometry(QtCore.QRect(20, 120, 256, 256))  #1160, 360, 81, 27
        self.graphicsView.setObjectName("graphicsView")
        self.graphicsView_2 = QtWidgets.QGraphicsView(Form)
        self.graphicsView_2.setGeometry(QtCore.QRect(320, 120, 256, 256))
        self.graphicsView_2.setObjectName("graphicsView_2") 

        self.graphicsView_4 = QtWidgets.QGraphicsView(Form)
        self.graphicsView_4.setGeometry(QtCore.QRect(620, 120, 256, 256))
        self.graphicsView_4.setObjectName("graphicsView_2") 

        self.graphicsView_3 = QtWidgets.QGraphicsView(Form)
        self.graphicsView_3.setGeometry(QtCore.QRect(1060, 120, 256, 256))
        ...
        self.pushButton_28.clicked.connect(Form.generate_part)
        self.pushButton_29.clicked.connect(Form.perturbate_part)

        self.pushButton_30.clicked.connect(Form.open_style)
        self.pushButton_31.clicked.connect(Form.edit_style)

        QtCore.QMetaObject.connectSlotsByName(Form)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "CA2SIS"))
        self.pushButton.setText(_translate("Form", "Genera"))
        self.pushButton_2.setText(_translate("Form", "Apri Immagine"))
        self.pushButton_3.setText(_translate("Form", "Apri Maschera"))
        self.pushButton_4.setText(_translate("Form", "Da Capo"))
        self.pushButton_5.setText(_translate("Form", "Annulla"))
        self.pushButton_6.setText(_translate("Form", "Salva Immagine"))
        self.pushButton_7.setText(_translate("Form", "Sfondo"))
        self.pushButton_8.setText(_translate("Form", "Pelle"))
        self.pushButton_9.setText(_translate("Form", "Naso"))
        self.pushButton_10.setText(_translate("Form", "Occhiali"))
        self.pushButton_11.setText(_translate("Form", "Occhio Sinistro"))
        self.pushButton_12.setText(_translate("Form", "Occhio Destro"))
        self.pushButton_13.setText(_translate("Form", "Soprac. Sinistro"))
        self.pushButton_14.setText(_translate("Form", "Soprac. Destro"))
        self.pushButton_15.setText(_translate("Form", "Orecchio Sinistro"))
        self.pushButton_16.setText(_translate("Form", "Oreccion Destro"))
        self.pushButton_17.setText(_translate("Form", "Bocca"))
        self.pushButton_18.setText(_translate("Form", "Labbro Superiore"))
        self.pushButton_19.setText(_translate("Form", "Labbro Inferiore"))
        self.pushButton_20.setText(_translate("Form", "Capelli"))
        self.pushButton_21.setText(_translate("Form", "Cappello"))
        self.pushButton_22.setText(_translate("Form", "Orecchino"))
        self.pushButton_23.setText(_translate("Form", "Collana"))
        self.pushButton_24.setText(_translate("Form", "Collo"))
        self.pushButton_25.setText(_translate("Form", "Vestiti"))
        self.pushButton_26.setText(_translate("Form", "+"))
        self.pushButton_27.setText(_translate("Form", "-"))


        self.pushButton_28.setText(_translate("Form", "Genera Parte"))
        self.pushButton_29.setText(_translate("Form", "Perturba Parte"))

        self.pushButton_30.setText(_translate("Form", "Apri Im. Stile"))
        self.pushButton_31.setText(_translate("Form", "Genera Stile"))
...
#         self.pushButton_26.setText(_translate("Form", "+"))
#         self.pushButton_27.setText(_translate("Form", "-"))
#         self.pushButton_28.setText(_translate("Form", "Generate Part"))
#         self.pushButton_29.setText(_translate("Form", "Perturbate Part"))
